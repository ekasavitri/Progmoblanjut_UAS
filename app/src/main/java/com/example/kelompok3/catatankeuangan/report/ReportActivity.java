package com.example.kelompok3.catatankeuangan.report;
...
import com.example.kelompok3.catatankeuangan.RangkumanActivity;
import com.example.kelompok3.catatankeuangan.KategoriPendapatan;
import com.example.kelompok3.catatankeuangan.KategoriPengeluaran;
import com.example.kelompok3.catatankeuangan.MainActivity;
import com.example.kelompok3.catatankeuangan.R;
...
public class ReportActivity extends AppCompatActivity
    ...
    //spinner untuk tambah bulan dan action pilih bulan - tahun
    public void loadMonth() {
        final String[] Bulan = {"Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember", "Januari"};
    ...
    //set data pengeluaran kke chart
    ...
    // mengambil data pendapatan dalam bulan
    ...
    // mengambil data pengeluaran dalam bulan
     ...
     */
    // mengubah decimal format dari chart data
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(ReportActivity.this, RangkumanActivity.class);
            startActivity(intent);
